...
<body>'; include 'inc/header.php'; echo '
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                ...
                <a href="create-amendes.php"><button type="button" class="btn btn-success">Add Fines</button></a>
  ...
  $reponse = $bdd->query('SELECT * FROM fines ORDER BY id DESC');
  ...
  <form action='inc/delete_entry.php' method='post'>
                  <tr>
                    ...
                    <td><?php echo $data['price']; ?></td>
                                                 ...
                                                 <?php
    echo '<td>
                                                         <button type="submit" name="deletefines" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                 </td>';
?>
                                            </form>
                                            </tr>
