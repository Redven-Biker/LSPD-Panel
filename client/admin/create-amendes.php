          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                ...
                <center>
                <form action="add-amendes-post.php" method="post">
                <h5>Name</h5>
                <input type="text" class="form-control py-2 mb-3" name="name" placeholder="Name" style="width: 350px;" required>
                <h5>Category</h5>
                <input type="text" class="form-control py-2 mb-3" name="category" placeholder="Category" style="width: 350px;" required>
                <h5>Price</h5>
