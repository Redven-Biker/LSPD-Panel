          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                ...
                <a href="create-news.php"><button type="button" class="btn btn-success">Add news</button></a>
  ...
  <form action='inc/delete_entry.php' method='post'>
                  <tr>
                    ...
                    <td><?php echo $data['date']; ?></td>
                                                 ...
                                                 <?php
    echo '<td>
                                                         <button type="submit" name="deletenews" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                 </td>';
?>
                                            </form>
                                            </tr>
