...
<body>'; include 'inc/header.php'; echo '
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                <h1 class="title-header">Tickets</h1>
  ...
  $reponse = $bdd->query('SELECT * FROM contravention ORDER BY id DESC');
  ...
  <form action='inc/delete_entry.php' method='post'>
                  <tr>
                    ...
                    <td><?php echo $data['date']; ?></td>
                                                 ...
                                                 <?php
    echo '<td>
                                                         <button type="submit" name="deletecontravention" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                 </td>';
?>
                                            </form>
                                            </tr>
