          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                <h1 class="title-header">Officier</h1>
                <a href="create-officier.php"><button type="button" class="btn btn-success">Add Officier</button></a>
  ...
  <form action='inc/delete_entry.php' method='post'>
                  <tr>
                    ...
                    <td><?php echo $data['date']; ?></td>
                                                 ...
                                                 <?php
    echo '<td>
                                                         <button type="submit" name="deleteusers" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                 </td>';
?>
                                            </form>
                                            </tr>
