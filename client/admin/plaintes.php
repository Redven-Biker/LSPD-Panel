...
<body>'; include 'inc/header.php'; echo '
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                <h1 class="title-header">Complaints</h1>
  ...
  $reponse = $bdd->query('SELECT * FROM complaints ORDER BY id DESC');
  ...
  <form action='inc/delete_entry.php' method='post'>
                  <tr>
                    <td><?php echo $data['victim']; ?></td>
                    <td><?php echo $data['reason']; ?></td>
                    <td><?php echo $data['witnesses']; ?></td>
                    <td><?php echo $data['suspect']; ?></td>
                    ...
                    <td><?php echo $data['hours']; ?></td>
                                                 ...
                                                 <?php
    echo '<td>
                                                         <button type="submit" name="deleterob" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                 </td>';
?>
                                            </form>
                                            </tr>
