          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                <h1 class="title-header">Create Vehicle theft</h1>
                <div class="btn-create"></div>
                <center>
                <form action="add-vol-vehicule-post.php" method="post">
                <h5>Owner</h5>
                <input type="text" class="form-control py-2 mb-3" name="owner" placeholder="Owner" style="width: 350px;" required>
                <h5>Plate</h5>
                <input type="text" class="form-control py-2 mb-3" name="plate" placeholder="Plate" style="width: 350px;" required>
                <h5>Suspect</h5>
