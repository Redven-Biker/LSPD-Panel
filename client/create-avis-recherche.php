          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center">
                <h1 class="title-header">Create Wanted Notice</h1>
                <div class="btn-create"></div>
                <center>
                <form action="add-avis-recherche-post.php" method="post">
                <h5>Wanted Person</h5>
                <input type="text" class="form-control py-2 mb-3" name="officier" value="'; echo $_SESSION['username']; echo '" style="display: none;">
                <input type="text" class="form-control py-2 mb-3" name="wanted_person" placeholder="Wanted Person" style="width: 350px;" required>
                <h5>Date</h5>
